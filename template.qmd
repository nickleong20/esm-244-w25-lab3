...
5. Building Models 
    ...
    f. model selection 
6. Finalize the model (train on whole dataset)
7. Interpret resuls/visualize/communicate 
...
```{r}
roc_auc(log_test, truth = survived, .pred_0)
roc_auc(lasso_test, truth = survived, .pred_0)
```
